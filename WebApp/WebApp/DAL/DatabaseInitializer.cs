...
namespace DAL
{
    ...
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        public async Task SeedAsync()
        {
            ...
            if (!await context.Customers.AnyAsync() && !await context.ProductCategories.AnyAsync())
            {
                ...
                context.Customers.Add(cust_1);
                context.Customers.Add(cust_2);
                context.Customers.Add(cust_3);
                context.Customers.Add(cust_4);

                context.Products.Add(prod_1);
                context.Products.Add(prod_2);

                context.Orders.Add(ordr_1);
                context.Orders.Add(ordr_2);
